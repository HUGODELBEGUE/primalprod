...
<section id="about">
    <div class="boxmodel">
        <h2>A propos</h2>
        <hr class="line-title">
        <p style="text-align: right; margin-bottom: initial;"><img class="avatar" src="./assets/images/avatar.jpg" alt="avatar" width="150">Comme indiqué plus haut, je m'appelle Hugo et j’habite dans la ville de Grenoble. Depuis maintenant environ 3 ans, je suis accompagné d’une chienne tout droit venue des Antilles, un mélange de races, qui lui donne une très belle robe et un caractère tout aussi affectueux et attachant. Bien que passionné par ce métier et passant la plupart de mon temps devant un ordinateur, j'ai aussi d'autres passions qui animent ma vie, comme écouter la musique pendant des heures, danser à en avoir le tournis, de longues promenades dans la forêt et bien sûr la mécanique et les bricolages en tout genre. Je pose également régulièrement comme modèle vivant pour différents ateliers de peinture. Ayant grandi à la campagne entouré d'animaux et de nature, je suis particulièrement sensible aux rapports avec celle-ci et à ces bienfaits. La terre est unique et mérite d'être respectée, c'est pourquoi je construis ma vie de manière à la préserver.</p>
        <h3 style="margin: 1.5em 0;">Mon parcours..</h3>
        <p style="text-align: left; margin-top: initial;">Avant de m’intéresser au domaine, je travaillais dans un secteur bien différent. En effet, j'ai exercé la profession de coiffeur pendant 7 ans, puis je me suis reconverti pour me laisser une chance de m’épanouir pleinement. Après un moment de réflexion, j'ai fait quelques essais dans divers secteurs, réparateur vélo, vendeur en magasin Bio, mais sans vraiment de suite.
            <br>
            Après de longues réflexions, j’ai découvert le métier de développeur web. J'ai donc aiguisé ma curiosité et commencé à me renseigner sur le sujet. En me cultivant et en me formant, j'ai appris les bases, et j'y ai pris beaucoup de plaisir. Maintenant, avec un diplôme de Développeur web/mobile en poche, je me sens complètement capable de grandir dans ce domaine. Je cherche constamment à évoluer, et continue à me former davantage pour accroître mes compétences et donner un service de qualité.
        </p>
